"""Review built K–7 assets, not the source alone. No live video playback is claimed."""
...
with sync_playwright() as p:
    ...
    if hub=='equity-hub':
        ...
        assert page.locator('.earth-hub-entry nav a').count()==3
        ...
        checks.append({'equityEntry':True,'threeK7GradeLinks':True})
    if hub=='learn':
    ...
    if hub=='learn':
        ...
        assert page.locator('#band option').all_text_contents()==['K–2','3–5','6–7']
        for band, count in [('K–2',4),('3–5',4),('6–7',6)]:
        ...
        page.locator('#band').select_option('6–7')
...
print(f'PASS: {hub}, {len(checks)} K–7 route checks, no JavaScript exceptions')
