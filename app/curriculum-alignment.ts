...
export const alignmentByArc: Record<string, ArcAlignment> = {
  ...
  "social-power-rights": { bigIdeas: [2], competencies: [[0, 0], [1, 1], [1, 3], [1, 4], [1, 5]], content: [[0, 2], [0, 3]], stage: "Practise + demonstrate", note: "Simulations, official sources, and cases connect evidence, consequences, perspectives, power, government systems, rights, remedies, and accountable civic decisions." },
