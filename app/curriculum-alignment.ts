...
export const alignmentByArc: Record<string, ArcAlignment> = {
  "ela-belonging": { bigIdeas: [0, 1], competencies: [[0, 7], [0, 8], [1, 0], [1, 4]], content: [[0, 0], [1, 1], [2, 0]], stage: "Introduce + practise", note: "Oral story, listening, identity, and a safe writing process open the year." },
  ...
  "social-global-systems": { bigIdeas: [0, 1], competencies: [[1, 1], [1, 3], [1, 4], [1, 5]], content: [[0, 0], [0, 1], [0, 4], [0, 5], [0, 6], [0, 7]], stage: "Introduce + practise", note: "Movement, inequality, resources, trade, conflict, and cooperation are studied as connected systems." },
...
export const subjectCoverageNotes: Record<string, { scope: string; strength: string; next: string[] }> = {
  "English Language Arts": { scope: "Strong thematic first pass", strength: "Stories, perspective, media, choice reading, research, poetry, creation, revision, and audience form a logical year.", next: ["Add an attributed First Peoples oral-text anchor.", "Build recurring reading-strategy and conventions mini-lessons.", "Make language varieties, paragraphing, sentence work, spelling, and grammar more visible."] },
