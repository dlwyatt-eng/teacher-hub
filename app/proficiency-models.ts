...
export const proficiencyModelSets = [
  ...
  },
  {
    ...
    subtitle: "The same complete graphic-score task at four points of growth—with a useful next move at every level",
    ...
    sourceCapsule: {
      label: "Teacher-authored fictional model · Rain-window graphic score",
      text: "All examples use the same low-risk Classroom OS task. They do not imitate a named artist and are not templates to copy. Transfer the visible moves to visual art, music, drama, dance, media, or mixed media.",
    },
  ...
  },
  {
    ...
    activityIds: ["bloxels-game-studio", "cold-test-prototype", "audience-remix", "safer-impact-studio", "zoo-design-studio", "each-one-teach-one"],
