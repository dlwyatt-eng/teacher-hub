...
export const proficiencyModelSets = [
  ...
  },
  {
    ...
    activityIds: ["trace-the-claim", "fleetwood-case-file", "graph-story-lab", "signal-case", "search-under-hood"],
  ...
  {
    id: "arts-intention-technique-revision",
    title: "Arts Process: Intention, Technique & Revision",
    subtitle: "One transferable Arts-process example—not a model of this activity's required product",
    activityIds: ["four-arts-languages", "map-what-maps-miss", "same-facts-frame", "rights-in-thirty", "audience-remix", "cosmic-scale-gallery"],
    spacesEvidenceIds: ["spaces-oct-case", "spaces-feb-inquiry", "spaces-june-minecraft"],
    prompt: "Create a complete short work or score with a clear intention, use taught Arts elements, show source/context care, gather response evidence, make a visible revision, and name a next improvement.",
    sourceCapsule: {
      label: "Teacher-authored process example · not this task's answer",
      text: "These fictional Rain-window graphic-score responses show how intention, technique, response evidence, and revision can grow. Unless the current lesson is the graphic-score studio, students are not being asked to make this product. Transfer only the thinking moves to visual art, drama, dance, media, or mixed media.",
    },
    criteria: ["Artistic intention", "Use of taught elements and technique", "Complete and readable work/score", "Response evidence and revision", "Context/credit and next improvement"],
    copyGuard: "Students must use their own intention, evidence, material, movement, sound, image, and source/context. Length, confidence, realism, expensive materials, decoration, and performance charisma are not proficiency criteria.",
    teacherUse: [
      "Show one model only after students have made a first attempt. Ask students to notice one transferable move, then close the model before revision.",
      "Say explicitly that the Rain-window score is a process example, not the current activity's answer or required art form.",
      "Use the same criteria across forms: a storyboard, dance score, visual composition, sound work, installation, or live performance may show equivalent learning.",
      "Pair every model with its next improvement so no level is presented as failure or perfection.",
      "Assess recent, varied evidence. One polished performance or SpacesEDU post never determines the term level.",
    ],
    models: [
      {
        level: "Emerging",
        growthLabel: "The idea and one artistic choice are visible",
        sample: "My piece is called Rain. I drew dots for taps and we played them on the desk. I wanted it to sound like rain. We changed one dot after the other group got confused. Next time I would make the ending clearer.",
        whatWorks: ["Names an intention", "Uses a graphic symbol for sound", "Recognizes that a performer response led to change"],
        nextImprovement: "Complete the whole score with a symbol key and timeline, add intentional silence or dynamics, and record exactly where performers became confused.",
        teacherUseNote: "The artistic thinking has begun. Conference with the student's own score: Where does it start? What does each mark mean? How will performers know it ends? Do not ask for more decoration.",
      },
      {
        level: "Developing",
        growthLabel: "Taught elements begin to serve the intention",
        sample: "I wanted separate raindrops to build into a storm. My key shows a dot is one tap, a line is a brush sound, and an empty box is silence. The score repeats A and then gets louder in B. The new group paused at my stacked symbols, so I drew a line to show they start together. I still need a clearer ending.",
        whatWorks: ["Connects rhythm, timbre, silence, form, and dynamics to an intention", "Makes notation readable with a key", "Uses a specific performer pause to revise"],
        nextImprovement: "Finish the score with a precise ending, test the revision again, and explain whether the changed notation produced the intended audience effect.",
        teacherUseNote: "Developing evidence is coherent but not yet fully verified. Ask for the second performance and final ending rather than a longer artist statement.",
      },
      {
        level: "Proficient",
        growthLabel: "Technique, evidence, and revision work together",
        sample: "My intention was to move from isolated drops to a layered downpour and end with one quiet trace. The 32-second score uses an eight-beat pulse, spaced tap rhythms, two beats of silence, a soft-to-medium crescendo, two sound layers, A–A–B form, and one final tap. I credited the NAC listening source that helped me notice texture, but my sounds and score are original. In the first no-coaching performance, both groups entered B at different times because the layers were not aligned. I added a shared timeline and conductor cue. In round two they entered together and the audience described the build and quiet ending. Next I would test whether the visual-only route communicates the same timing.",
        whatWorks: ["Uses several taught musical elements deliberately", "Credits a mentor encounter without copying it", "Connects precise performer and audience evidence to a meaningful revision", "Names a focused access-oriented next test"],
        nextImprovement: "Run the visual-only route with a new group and revise any colour-only or timing cue that still depends on hearing the composer's explanation.",
        teacherUseNote: "This meets the Grade 6 target because intention, technique, credit, evidence, and revision are all visible. The same depth can be shown through a score plus a 30-second conference.",
      },
      {
        level: "Extending",
        growthLabel: "The artist tests choices across forms, audiences, or constraints",
        sample: "I tested two ways to create the same rain-to-quiet arc: a performed sound score and a silent movement/shape score. Both use A–A–B form, growing density, a held pause, and one isolated ending. The sound performers initially disagreed about layered entries, while the movement group understood time but relied on blue colour to identify B. I aligned both scores on the same count grid, added shape patterns as well as colour, and retested with new groups. Both reached the ending without coaching, but the silent route made the gradual dynamic change less clear. My next experiment would vary size and spacing to represent intensity without adding more symbols. The NAC source influenced my attention to texture; the compositions and notation are ours.",
        whatWorks: ["Transfers an intention across two Arts forms", "Distinguishes different test evidence and revises each route", "Designs beyond colour-only information and acknowledges an unresolved limitation", "Separates mentor influence from original work"],
        nextImprovement: "Define one success indicator for intensity before the next silent-route test, then decide whether size, spacing, or movement quality communicates it with the least added complexity.",
        teacherUseNote: "Extending is transfer, discrimination among evidence, and an accountable trade-off—not extra length, effects, or virtuosity. A compact paired score can show it.",
      },
    ],
  },
  {
    ...
    activityIds: ["access-by-design", "bloxels-game-studio", "cold-test-prototype", "audience-remix", "science-design-series", "safer-impact-studio", "zoo-design-studio", "each-one-teach-one", "cosmic-mission-control"],
    spacesEvidenceIds: ["spaces-jan-bloxels", "spaces-apr-zoo", "spaces-may-design", "spaces-june-minecraft"],
