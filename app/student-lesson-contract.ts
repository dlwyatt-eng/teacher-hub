...
const reviewedStudentLessonContracts = {
  ...
  "learning-user-manual": {
    ...
    why: "We are learning to notice strengths and try useful strategies. Use examples you are comfortable using. Made-up school examples are welcome. What helps can change with the task.",
    firstAction: "Choose a recent class moment or invent a school example. Write or draw what the learner did.",
    ...
    steps: [
      { title: "Start with evidence", action: "Describe two real or made-up school moments: what happened, what the learner did, and the result. Leave out private details. Describe actions, not personality labels.", finishCheck: "Another person can see the action in each example instead of only reading a praise word." },
      ...
      { title: "Choose what to share", action: "Review the guide privately with your teacher. You may choose one safe strength or goal for a separate Learning Story, or keep it all private.", finishCheck: "The private profile is useful to the teacher, and any shared part was chosen by you." },
    ],
    finishEvidence: ["Two observable learning examples", "Two strengths connected to evidence", "Two helpful conditions paired with student responsibility", "One realistic goal with a first step, check date, and help source", "A choice to keep the guide private or use one safe idea in a separate Learning Story"],
    saveAction: { kind: "add-to-existing-post", message: "Keep the full guide private with your teacher. If you choose to share, your teacher asks permission again before a safe part you choose is copied into a separate Learning Story. Never upload the original." },
    readiness: "none",
  },
  "packet-rescue": {
    id: "packet-rescue",
  ...
  "cold-test-prototype": {
    ...
    firstAction: "Describe who will use your design without naming a person. State the one need it must meet and one sign that it works.",
    ...
    steps: [
      { title: "Meet the need", action: "Describe who will use your first version, what they need, and the accurate idea it must explain.", finishCheck: "The need is specific and the content has been checked." },
      ...
      { title: "Watch without helping", action: "Let another team try it. Record their first action, pauses, questions, and confusion without names.", finishCheck: "The notes check both content and ease of use. Record what worked and any difficulty you actually observed; do not invent a problem." },
      { title: "Improve and retest", action: "Use your observations to choose a useful change, then retest it. Check both content and ease of use. If both worked, try a new example or ask another group to test before deciding what to improve.", finishCheck: "The before-and-after tags show what changed and whether it helped." },
    ],
    finishEvidence: ["A clear user, need, and success rules", "A smallest usable version", "A no-name test record", "A check of content and ease of use", "An evidence-based change or a reason to keep the design after another test", "A retest result"],
  ...
  "science-design-series": {
    ...
    steps: [
      ...
      { title: "Test fairly", action: "Test each version in the same way so you can compare them. Record measurements, what did not work, and the exact feedback you received.", finishCheck: "The test conditions are similar enough to compare and no failure is hidden." },
      { title: "Improve and explain", action: "Change one feature and test it again in the same way. Explain the result, any waste, other effects of your design, and the next problem to solve.", finishCheck: "The before-and-after evidence shows whether the change helped and what remains." },
    ],
    finishEvidence: ["A completed design brief", "A labelled first version and prediction", "A table of results from tests done in the same way", "A tested revision", "An explanation of the result, waste, other effects, and the next problem"],
  ...
  "each-one-teach-one": {
    ...
    why: "We are learning to check an idea, plan how to teach it, watch someone try it, and use what happens to improve it.",
    ...
    choices: [
      {
        ...
        options: [
          ...
          { label: "Private app / site prototype", detail: "Sketch each screen on paper first. Use only a teacher-approved school tool. Do not publish publicly, allow comments, track visitors, use personal accounts, or include student information." },
        ],
      },
      {
    ...
    steps: [
      { title: "Choose the question", action: "Choose one focused question your teacher has approved and describe who you want to teach. Keep the question suitable for school. Do not give personal advice, share private information, or teach unsafe actions.", finishCheck: "The question is focused enough to teach in 5–10 minutes, and the audience is described without identifying anyone.", minutes: "Block 1 · 10–15 min" },
      { title: "Verify the idea", action: "Use at least two teacher-approved sources. For each one, record who made it, its title, its date if available, and where to find it. Add the idea it supports and one limit or uncertainty.", finishCheck: "Every key teaching claim can be traced to a source, and one honest limit remains visible.", minutes: "Blocks 1–2" },
      { title: "Set the design rules", action: "Write one sentence saying what you want someone to learn. Add three signs that your teaching works. List your limits for time and tools, your safety rules, how people can take part, what must stay private, and what may be shared.", finishCheck: "The rules describe learner understanding and use—not decoration, device power, or how much was built.", minutes: "Block 2 · 15–20 min" },
      { title: "Draw the whole path", action: "Draw the whole path on paper. Show how you will invite someone in, what they do first, and what information they need. Add a useful choice or task, a response that helps them know how they did, a check of what they learned, and an ending. Show how they can go back if they get stuck.", finishCheck: "A partner can trace the complete path from beginning to ending without the designer filling a missing step.", minutes: "Block 2" },
      ...
      { title: "Watch a new learner", action: "Ask someone who has not seen your design to try it without hints. Record what they do first, where they pause, what idea they understand, which feedback they notice, and one thing that gets in their way. Never record their name, account, image, or a personal comment about them.", finishCheck: "The notes describe observable actions and one exact point to improve without identifying the learner.", minutes: "Block 5" },
      { title: "Revise and retest", action: "Use the test results to change one part of what you teach. Also improve one way people take part, find the next step, or get helpful feedback. Ask someone to try the changed parts again.", finishCheck: "The before/after record connects each change to test evidence and shows what happened in the second try.", minutes: "Blocks 5–6" },
      { title: "Teach, check, and reflect", action: "Teach your lesson. Ask the learner to name the main idea, explain it, use it in a new example, and name a source or limit. Credit your sources and tools. Explain what you contributed, what evidence you used, what you changed, what still has a limit, and what you would improve next.", finishCheck: "The final explanation is in your own words; no raw AI output or learner responses are copied into SpacesEDU.", minutes: "Blocks 7–8" },
    ],
    finishEvidence: ["A focused question, who you will teach, what they should learn, three signs it works, and the limits you must follow", "Two teacher-approved source records with a limit", "A paper plan showing every step from the invitation to the ending, including a way back", "A usable first version through one of five equivalent routes", "A no-name learner-test record", "One change to what you teach, plus one change that helps people take part, find their way, or use feedback", "A four-part understanding check", "Your own reflection: what you contributed, the evidence you used, a limit, what you changed, and your next improvement"],
