...
export const publishedDayPlans:DayPlan[]=[tuesdayDay,mondayDay,thirdDay,secondDay,flexibleFirstDay,firstDay];
export const DEFAULT_DAY_PLAN_ID=tuesdayDay.id;
