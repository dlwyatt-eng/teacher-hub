...
export const aiLiteracySources: readonly AiSource[] = [
  {
    ...
    use: "A Canadian consultation open July 23–September 23, 2026; use it as an archived governance case after the deadline.",
  },
  {
  ...
  },
  {
    ...
    use: "Canadian guidance for privacy, transparency, accountability, safeguards, and meaningful human oversight.",
  },
  {
    id: "canada-copyright-ai",
    title: "Consultation on Copyright in the Age of Generative Artificial Intelligence — What We Heard Report",
    organization: "Innovation, Science and Economic Development Canada",
    ...
    use: "Competing Canadian stakeholder positions on authorship, consent, credit, compensation, and innovation; not a statement of settled law.",
  },
  {
    id: "ilo-ai-jobs",
    ...
    use: "Evidence for discussing tasks within occupations, job transformation, exposure, inequality, and the distribution of benefits.",
  },
] as const;
...
export const aiDilemmas: readonly AiDilemma[] = [
  ...
  },
  {
    ...
    lessonIds: ["turning-point-remix", "four-arts-languages", "impossible-scene-repair"],
    sourceIds: ["wipo-ai-ip", "canada-copyright-ai"],
  ...
  },
  {
    ...
    questions: ["What data would it collect?", "Who might this system misread or exclude?", "Who gets to challenge the result?", "What should a human still decide?"],
    curriculum: ["ADST", "Career Education", "Equity"],
    lessonIds: ["learning-user-manual", "power-in-the-room", "rights-in-tension", "access-by-design"],
    sourceIds: ["unicef-ai-children", "unesco-ai-ethics", "canada-privacy-ai"],
  ...
  {
    id: "work-half-tasks",
    title: "When the tasks change",
    situation: "A workplace introduces AI that can perform several tasks inside a job, but not the entire job.",
    ...
    lessonIds: ["career-constellation", "supply-chain-shockwave", "data-skyline"],
    sourceIds: ["oecd-ai-education", "ilo-ai-jobs", "canada-transparency"],
  ...
  },
  {
    ...
    lessonIds: ["learning-user-manual", "digital-identity-forensics", "trusted-health-studio"],
    sourceIds: ["unicef-ai-children", "unesco-ai-ethics", "canada-privacy-ai"],
  ...
  },
  {
    ...
    lessonIds: ["trusted-health-studio", "data-skyline", "body-case-conference"],
    sourceIds: ["unicef-ai-children", "unesco-ai-ethics", "canada-privacy-ai"],
  ...
  },
  {
    ...
    curriculum: ["Social Studies", "ADST", "Global Citizenship"],
    lessonIds: ["cooperation-control-room", "rights-in-tension", "compare-government-systems"],
    sourceIds: ["unesco-ai-ethics"],
