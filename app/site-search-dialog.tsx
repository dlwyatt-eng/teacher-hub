...
import type { SiteSearchDialogProps, SiteSearchTarget } from "./site-search";
...
const teacherPages = [
  ...
  ["TOC & Emergency Plans", "Open the substitute-teacher day-plan builder, emergency preflight, device-free fallback guidance, and reserved Missing Time Capsule destination."],
...
export default function SiteSearchDialog({ audience, onNavigate, onClose }: SiteSearchDialogProps) {
