...
export default function TeacherQuickCheckBuilder({
  ...
  return <section className="teacher-quick-check-builder" aria-labelledby={titleId}>
    ...
    <aside className="teacher-quick-check-builder__routes">
      ...
      <article className="caution"><b>JOTFORM · OPTIONAL NO-NAME CHECK</b><p>Use only for low-risk closed choices. Do not request names, emails, class IDs, uploads, locations, health/family details, or open personal responses, and keep results private. Submission IP may still be retained, so describe the form as no-name—not fully anonymous. Offer the equivalent paper check.</p><a href="https://www.jotform.com/help/31-how-to-find-the-ip-addresses-of-form-respondents/" target="_blank" rel="noreferrer">IP documentation ↗</a><a href="https://www.jotform.com/answers/4686253-how-to-disable-capturing-ip-addresses" target="_blank" rel="noreferrer">Capture setting answer ↗</a></article>
    </aside>
