...
export const subjects: Subject[] = [
  ...
  { name: "Social Studies", short: "Social Studies", icon: "◎", color: "#4f75a6", soft: "#e2eaf4", units: 4, status: "4 units · year pathway in final classroom completion", updated: "Updated Sep. 6", sourceUrl: "https://curriculum.gov.bc.ca/curriculum/social-studies/6/core" },
