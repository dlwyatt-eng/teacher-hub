...
export const unitWorlds: Record<string, UnitWorldTheme> = {
  "ela-werewolf": world({ id: "ela-werewolf", name: "The Moonlit Village", family: "forest", spectrum: ["Natural", "Artistic"], environment: "A fictional village for learning game rules, practising stories and listening together.", metaphor: "Each observation becomes a trail marker; each respectfully shared story helps the class find its bearings.", entry: "Forest edge", destination: "Listening circle", progressNoun: "trail markers", icon: "◌", sky: "#dfe9d9", ground: "#183b30", accent: "#d8a954", accent2: "#7fad87", ink: "#f7f3e7", glow: "#f8d989", image: "/images/visual-review/unit-world-listening-grove-v1.webp", imagePosition: "center 52%" }),
