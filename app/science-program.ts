...
export const scienceUnits: ScienceUnit[] = [
  {
    ...
    lessons: [
      ...
      experience("systems-jigsaw", "Four systems, one body", "How can different body systems do different jobs and still act as one connected system?", "2 × 55–65 min", "Inquiry studio", {
        ...
        hook: "Each team learns about one body system: nervous, hormonal, excretory, or reproductive. Teams then teach one another.",
        ...
        success: ["I can name the main job and important structures of one system.", "I can trace what moves through the system.", "I can explain how two systems work together and one thing my model cannot show."],
        ...
        materials: ["Four expert briefs", "Approved system diagrams", "Chart paper or floor arrows", "Small paper circles to represent messages or materials", "Mixed-group note catcher"],
        teacherPrep: {
          beforeClass: ["Assign one of four systems to each expert group: nervous, hormonal, excretory, or reproductive.", "Bookmark the specific KidsHealth body movie/article each team will use and prepare one district-approved reproductive-system diagram.", "Preview FNESC’s Science First Peoples guide and its Bears and Body Systems blackline masters before using the transfer scene; teach only what the named source supports.", "Project the body-system notes. Students prepare a labelled diagram and notes about its job, what travels, how another system helps, and what the diagram cannot show. For peer teaching, use four boxes on paper, one for each system."],
          perGroup: ["One approved source", "Paper, pencils, and small paper circles for the diagram demonstration", "One chart page", "Three-minute teaching timer"],
          displayOrPrint: ["Display the six-step checklist in Prepare teaching: prediction, labelled diagram, paper-circle demonstration, how two systems work together, what the model cannot show, and a question with its answer.", "For transfer, display or print only the FNESC Inside a Bear, Inside a Human, and comparison materials needed for the selected structure–function relationship."],
        ...
        lessonResources: [
          { scene: 0, type: "Video", label: "Nervous-system expert source", url: "https://kidshealth.org/en/kids/nsmovie.html", source: "Nemours KidsHealth · medically reviewed", gradeFit: "Core Grade 6", support: "Assign to nervous-system experts. Stop after students can trace receptor → sensory message → processing → motor message → response.", task: "Collect the system job, key structures, what moves, one connection, and one thing your model cannot show." },
          ...
          { scene: 0, type: "Video", label: "Excretory-system expert source", url: "https://kidshealth.org/en/kids/usmovie.html", source: "Nemours KidsHealth · medically reviewed", gradeFit: "Core Grade 6", support: "Assign to excretory-system experts. Focus on filtering blood, returning needed materials, and the urine route.", task: "Explain that kidneys filter blood, which returns to circulation. Trace the separate urine path: kidneys → ureters → bladder → urethra." },
          { scene: 0, type: "Teacher-selected source", label: "Reproductive-system expert source", source: "Surrey Schools or teacher-approved health resource", gradeFit: "Core Grade 6", support: "Use one district-approved diagram or source. Do not direct students to open-web anatomy searches.", task: "Identify the biological job, approved structures, what moves or changes, one hormonal connection, and one thing your model cannot show." },
        ...
        scenes: [
          { label: "Become expert", title: "Draw how your body system works", prompt: "Use your assigned source to explain the system’s job. Draw and label its parts, then add arrows showing where messages or materials travel. Explain how another system helps and one thing the drawing cannot show.", teacherCue: "Approve each team's five evidence notes before construction. Redirect part-lists into a route or causal model.", time: "35–40 min", learningMode: "Expert teams · source · route model", studentTask: "Five sourced notes and one route model" },
          { label: "Prepare teaching", title: "Make classmates do the thinking", prompt: "Use the six-step checklist to plan your lesson. Draw and label the steps, use a paper circle to show what travels, and prepare questions for classmates. Explain how another system helps and what your model cannot show.", teacherCue: "Conference on scientific accuracy and audience action. A speech with copied facts is not ready.", time: "20–25 min", learningMode: "Expert teams · lesson design · rehearsal", studentTask: "A three-minute interactive expert lesson" },
      ...
      experience("body-case-conference", "Body systems case conference", "Can we explain a new body situation without reducing it to one organ or one system?", "60–70 min", "Case file", {
        kind: "Assess",
        auditStatus: "needs-audit",
        hook: "Teams receive different fictional cases: a hot tournament, a sudden start signal, a long bus ride after drinking plenty of water, or changing sleep and growth during puberty.",
        ...
        reflection: "Which arrow best explains how two body parts work together? How did a classmate help you make it clearer?",
        ...
        scenes: [
          { label: "Diagnose", title: "Which evidence matters?", prompt: "Open a fictional case, separate observations from assumptions, and select the systems the evidence actually requires.", teacherCue: "Reject choices based only on familiar body words. Ask which clue requires each selected system.", time: "15 min", learningMode: "Case reading · evidence triage", studentTask: "An explanation, three case clues, and at least two body systems linked to those clues" },
          { label: "Build", title: "Show how one body response leads to the next", prompt: "Draw the body parts involved and connect them with arrows. Label what each part sends or does. Add a note about one thing the case or your diagram cannot tell us.", teacherCue: "Conference before teams decorate or open Minecraft. Check every arrow for a verb and a scientific reason.", time: "25–30 min", learningMode: "Systems modelling · teacher conference", studentTask: "A diagram with five to eight labelled arrows and one note about what it cannot show" },
    ...
    lessons: [
      ...
      experience("mixture-toolkit", "Separation toolkit lab", "Why does each separation method work—and when does it fail?", "2 × 55–65 min", "Field lab", {
        kind: "Investigate", auditStatus: "needs-audit", hook: "Teams become experts on one separation method, test it on several mixtures, and teach classmates both its useful property and its limits.", learning: "We are learning that a method works because of a difference in properties, not because it belongs in a memorized sequence.", success: ["I connect a method to the property it uses.", "I can show what passes through or remains.", "I can explain a case in which the method would fail."], vocabulary: ["sieving", "filtration", "magnetism", "decanting", "evaporation", "chromatography"], learningModes: ["Expert-group jigsaw", "Mini investigations", "PhET interactive", "Peer teaching", "Application cards"], guided: "Assign each team a method and two test mixtures. Teams create a three-minute teaching demonstration, then students rotate and collect the limits of every method.", inquiry: "Test sieving, magnetism, skimming or decanting, filtration, chromatography, and evaporation; then choose methods for new real-world cases.", reflection: "What property mattered more than the name of the material?", exit: "Choose a method for a new mixture and name one reason it might not fully work.", materials: ["Method station tubs", "Sieves or screens", "Bagged magnets", "Funnels and filters", "Clear cups", "Sand, gravel, cork, steel, salt water", "Water-soluble markers and coffee filters", "Student notebooks"], teacherPrep: {
          ...
          { label: "Teach", title: "Build the class separation toolkit", prompt: "Teach your method, watch the other demonstrations, and record what each method separates, leaves behind, and cannot do.", teacherCue: "Run this as a jigsaw or station carousel. Peers should ask one challenge question at every station.", time: "40–45 min", learningMode: "Peer teaching · demonstrations · note making", studentTask: "Complete a six-method comparison chart and ask two groups about a limitation." },
          { label: "Apply", title: "Choose a method for a new problem", prompt: "Solve unfamiliar cases such as muddy water, recycling fragments, salt water, and mixed dry foods. Some need more than one step.", teacherCue: "Use the digital application board after the jigsaw. Invite multiple defensible sequences and make students name trade-offs.", time: "25–30 min", learningMode: "Scenario challenge · debate · notebook explanation", studentTask: "Defend two sequences and explain why a tempting alternative would fail." },
        ] }),
      experience("separation-rescue", "Mixture Rescue Challenge", "How much of the mixture can your team recover cleanly?", "2 × 60–70 min", "Field lab", {
        kind: "Investigate", auditStatus: "needs-audit", hook: "Every team receives the same unknown mixture and limited tool station. Teams must plan before opening the sample, recover clean fractions, and improve one weak step after comparing evidence.", learning: "We are designing and evaluating a multi-step separation process from evidence.", success: ["Our sequence is justified by component properties.", "We revise the plan when evidence shows a problem.", "We evaluate purity, recovery, efficiency, safety, and limitations."], vocabulary: ["sieving", "filtration", "magnetism", "evaporation", "purity", "recovery"], learningModes: ["Team planning", "Projected rehearsal", "Hands-on challenge", "Midpoint peer critique", "Evidence-based redesign"], guided: "Keep the record lean but the thinking substantial: one visual plan, one quick sketch of the midpoint problem, one revision, and one final explanation.", inquiry: "Plan, carry out, critique, and improve a separation sequence using a shared material kit and clear success criteria.", reflection: "Which revision produced the biggest improvement, and what evidence supports that?", exit: "Explain the strongest and weakest part of the team process using property, method, result, and limitation.", materials: ["One identical mixture per team", "Trays", "Bagged magnets", "Spoons or mesh skimmers", "Sieves", "Funnels and filter paper", "Clear collection cups", "Plan card and marker", "Goggles", "Overnight evaporation dish managed by the teacher"], teacherPrep: {
          ...
          { label: "Test", title: "Run the rescue—and stop halfway", prompt: "Carry out the plan carefully. Halfway through, sketch or circle one problem, compare with another team, and improve one step.", teacherCue: "Use the projected rehearsal only when a team is stuck. Pause all teams at the midpoint for a five-minute evidence exchange.", time: "45–50 min", learningMode: "Hands-on challenge · peer critique · revision", studentTask: "Collect fractions, sketch one problem, receive peer feedback, and revise one step." },
      ...
      experience("place-mixtures-studio", "Learning from place and source", "What changes when knowledge is connected to a specific people and place?", "1–2 × 60 min", "Inquiry studio", {
        kind: "Apply", auditStatus: "needs-audit", hook: "The teacher opens one of the supplied Surrey Schools Indigenous Learning sources about Katzie plant knowledge, cedar harvesting, or land and water care, then names the specific people, place, and source before making a science connection.", learning: "We are learning from a specific source in context and making a careful science connection without treating all First Peoples as one culture.", success: ["I name who the knowledge comes from and the place it belongs to.", "I record only what the source supports.", "I can make a science connection without claiming the two knowledge systems are identical."], vocabulary: ["place-based", "protocol", "knowledge holder", "responsibility"], learningModes: ["District-curated video or PDF", "Close source reading", "Discussion circle", "Two-perspective organizer", "Optional SpacesEDU note"], guided: "Preview the source, context, and permissions before class. Give the source enough time to be learned from; the digital organizer should support close attention, not replace it.", inquiry: "Read, watch, listen to, or learn directly from one supplied source, then distinguish source-supported learning from a separate science connection.", reflection: "What would be lost if this knowledge were reduced to a generic separation-method label?", exit: "Name the source, one learning it supports, and one thing we should not assume.", materials: ["One supplied Surrey Schools Indigenous Learning source", "Projected source-context organizer", "Student notebooks", "Optional school-approved local observation route"], teacherPrep: {
          ...
          { label: "Learn", title: "Stay with the source", prompt: "Read, watch, listen, or learn directly. Collect evidence about method, purpose, relationships, and responsibility.", teacherCue: "Plan at least two encounters with the source: first for the whole meaning, second for evidence. A blank organizer box is better than a guess.", time: "30–35 min", learningMode: "Close viewing/reading/listening · paired evidence notes", studentTask: "Collect three source-supported details and mark the exact moment, phrase, image, or section that supports each." },
          { label: "Connect", title: "Place two ways of knowing beside each other", prompt: "Separate what the source teaches, a science idea that may connect, and what neither perspective should be made to claim.", teacherCue: "Use two-eyed seeing carefully: place perspectives beside one another without forcing equivalence or translating all knowledge into Western categories.", time: "25–30 min", learningMode: "Discussion circle · two-perspective organizer", studentTask: "Write one sourced learning, one science connection, and one limit or responsibility." },
          { label: "Respond", title: "Return the learning respectfully", prompt: "Choose a brief response that shows accurate listening: a source note, thank-you question, concept sketch, or optional SpacesEDU notice and wonder.", teacherCue: "Follow the source's protocols. Do not require public posting or turn community knowledge into a generic final-project topic.", time: "20–25 min", learningMode: "Choice response · reflection · optional portfolio", studentTask: "Create a concise response with exact attribution and one question that does not ask the source to represent all peoples." },
        ] }),
    ],
  },
  {
    ...
    lessons: [
      ...
      experience("crash-lab", "Crash Lab", "How does padding change the force during a sudden stop?", "3 × 45–50 min", "Digital investigation", {
        ...
        scenes: [
          ...
          { label: "Explain", title: "Graph how the stop changes", prompt: "Compare stopping time and peak force together. Explain the mechanism rather than only naming the safest bar.", teacherCue: "Model two bar graphs: padding type on each horizontal axis, average stopping time (ms) on one vertical axis and average largest force (N) on the other. Replay the three padding conditions.", time: "35–40 min", learningMode: "Graphing · animation analysis · partner talk", studentTask: "Two bar graphs with separate scales (ms and N), plus an explanation" },
          { label: "Conclude", title: "Make the data do the talking", prompt: "Write or record your conclusion. Use results from more than one trial to support it, explain why they fit, and name one thing the model cannot show.", teacherCue: "Conference on the evidence and reasoning before students polish the response.", time: "25–30 min", learningMode: "CER response · conference · optional SpacesEDU", studentTask: "A checkpoint-ready CER explanation" },
        ],
      }),
      experience("movement-forces", "Forces in human movement", "How do forces help a body start, stop, jump, land, and change direction?", "1–2 × 60 min", "Case file", {
        ...
        success: ["I identify the object and interaction for each force arrow.", "I explain how the ground can push on a person.", "I compare two movement observations and explain what the evidence shows.", "I communicate one movement cue accurately and respectfully."],
        ...
        materials: ["Built-in kick drawings; teacher-selected clips optional", "Paper for before/during/after sketches", "Floor tape", "For the optional teacher test: one ball, a low cardboard ramp, cloth, ruler or tape measure, and a tray or barrier to catch the ball", "Tablets for slow motion optional", "Force-frame organizer"],
        teacherPrep: {
          beforeClass: ["Use the built-in three-frame kick sequence as the starting case. Two teacher-previewed movement clips are optional extensions.", "Prepare non-participation-equivalent video and object-analysis routes.", "Mark a safe observation zone; no maximum-effort jumping or competition is required."],
          perGroup: ["One force-frame organizer", "Built-in kick drawings or teacher-selected contrasting cases", "Device optional"],
        ...
        scenes: [
          { label: "Observe", title: "Freeze the instant when motion changes", prompt: "Use the built-in before, during and after kick drawings. Describe what changes before naming the force. Your teacher may add a previewed slow-motion clip.", teacherCue: "Open the three kick frames in order. Model: before contact, the foot is moving toward the ball; during contact, they touch; afterwards, the ball moves away. Students sketch and label these changes.", time: "20–25 min", learningMode: "Slow-motion observation · notice/wonder", studentTask: "Three frame-by-frame observations" },
          ...
          { label: "Test", title: "Change one movement condition safely", prompt: "For an object test, your teacher can release the same ball from the same short ramp onto a smooth surface, then onto a cloth-covered surface. Compare how far it rolls. Keep the ball and release point the same. Watch or record from a seated position; the teacher handles the equipment.", teacherCue: "Keep the ramp low, clear the landing area and catch the ball before any table edge. Model one trial on each surface; repeat three times and record distance. Use the built-in drawings for observation if materials are unavailable; do not claim that drawings are measured trials.", time: "30–40 min", learningMode: "Choice investigation · observation", studentTask: "A safe comparison and one evidence note" },
