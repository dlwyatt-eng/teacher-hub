...
export const sciencePacing: SciencePacingBlock[] = [
  ...
  { weeks: "June", focus: "Earth & Space + expert showcase", blocks: "15–18", purpose: "Use 7–8 blocks for the cosmic tour, then transfer established inquiry and audience-testing routines into an 8–10-block expert showcase.", inquiryMove: "Post one final team teaching artifact plus each student’s individual explanation; Minecraft is one optional format." },
];
...
export const scienceUnits: ScienceUnit[] = [
  {
    ...
    content: ["Nervous system", "Hormonal system", "Excretory system", "Reproductive system"],
    ...
    lessons: [
      ...
      experience("systems-jigsaw", "Four systems, one body", "How can different body systems do different jobs and still act as one connected system?", "2 × 55–65 min", "Inquiry studio", {
        ...
        curriculumFocus: {
          ...
          content: ["the basic structures and functions of body systems: excretory, reproductive, hormonal, and nervous"],
          whyThisFits: "Each expert teaches the structure, function, route, and one evidence-supported connection for an assigned Grade 6 body system; mixed groups then apply the combined model to a new case.",
        },
        ...
        teacherPrep: {
          beforeClass: ["Assign one of four systems to each expert group: nervous, hormonal, excretory, or reproductive.", "Bookmark the specific KidsHealth body movie/article each team will use and prepare one district-approved reproductive-system diagram.", "Project the five-part expert brief and have students draw a simple four-box note grid in a notebook or on plain paper."],
          perGroup: ["One approved source", "One route-model kit", "One chart page", "Three-minute teaching timer"],
          displayOrPrint: ["Display the four required teaching elements: job, important structures, what moves, one connection/limit.", "Project the connection-case cards after peer teaching."],
          answerKey: ["Nervous: receptors and nerve cells carry fast signals to and from the brain/spinal cord.", "Hormonal: glands release chemical messages into blood; effects are often slower and longer-lasting.", "Excretory: kidneys filter blood, regulate water/salts, and remove wastes through urine.", "Reproductive: structures produce reproductive cells and hormones and may support fertilization and development."],
        ...
        scenes: [
          ...
          { label: "Transfer", title: "Which systems explain the case?", prompt: "Study the case on the class screen. Choose the systems, trace what changes or moves, and explain why one system is not enough.", teacherCue: "Run the interactive cases as a whole-class check. Keep one case visible while mixed groups build an oral, board, or notebook explanation.", time: "20–25 min", learningMode: "Mixed groups → individual · case explanation", studentTask: "One multi-system explanation and one revision after feedback" },
        ],
      }),
  ...
  },
  {
    ...
    content: ["Scale and structure of the universe", "Age of the universe", "Solar-system position", "Motion in our galaxy"],
