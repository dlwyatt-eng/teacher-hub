...
export const yearMonths: YearMonth[] = [
  {
    ...
    focus: "Belonging, routines, learning profiles, and how inquiry begins",
    learning: "Students practise noticing, wondering, listening, discussion, source care, and responsible technology use while the class develops shared agreements.",
    subjects: ["ELA", "Career", "PHE", "Arts"],
    ...
    sequence: ["Weeks 1–2 · belonging, learning profiles, discussion and source-care routines", "Sept. 14–24 · truth-and-reconciliation learning and attributed local-place work", "Sept. 28–29 · revise and share the class learning display"],
  ...
  },
  {
    ...
    teachingTime: "Science Unit 4 · 7–8 blocks + expert inquiry/showcase · 8–10 blocks",
    ...
    preparation: "Set a firm minimum viable product; schedule groups early; protect individual reflection time; keep June 24 as closure rather than last-minute production.",
