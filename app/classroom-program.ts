...
export const yearMonths: YearMonth[] = [
  ...
  },
  {
    ...
    sequence: ["Weeks 1–2 · Maps Make Arguments using the three authentic map sources; add Can I disagree? as a 25-minute rights introduction", "Weeks 2–3 · Trace the Claim: Two Lies and a Truth + source verification", "Weeks 3–4 · perspective listening simulation and Fleetwood case file"],
  ...
  },
  {
    ...
    sequence: ["Weeks 1–2 · power-in-the-room simulation and levels of government", "Weeks 2–3 · compare government systems and trace how a decision moves; Nov. 9–20 · Where Is the Line? and children’s-rights proposals for National Child Day", "Weeks 3–4 · Juniper Park public-decision lab; inquiry teams form and choose topics"],
  ...
  },
  {
    ...
    sequence: ["Dec. 1–4 · human-rights cases and Universal Declaration source work", "Dec. 7–10 · Human Rights Day teaching gallery: rights, racism, expression and fair responses", "Dec. 11–18 · root causes, global connections, existing responses, and mid-year reflection"],
...
export const spacesEvidenceRhythm: SpacesEvidenceMoment[] = [
  ...
  { id: "spaces-feb-inquiry", month: "February", kind: "Required portfolio", title: "Social Studies Inquiry / Expert Teach-Back", subjects: ["Social Studies", "ELA", "ADST"], purpose: "Share one team teaching artifact while preserving individual thinking and contribution.", evidence: "Link the shared product once, or use one clear photo/video of the live teaching or model. Each student adds an evidence-based reflection naming their contribution and one revision.", sourceActivities: ["Social Studies Inquiry Project", "Expert-team teaching experience"], primaryActivityId: "expert-exchange", contributorActivityIds: ["source-mosaic", "pull-the-system-thread", "responses-under-pressure", "make-it-teachable", "hook-cold-audience", "cold-test-prototype", "project-rescue-studio", "leadership-relay"] },
