...
const rounds: readonly ScoreRound[] = [
  ...
  },
  {
    ...
    story: "The team shares 48 energy points equally among 6 players. Then the whole team earns one 4-point rescue bonus.",
    repeatLabel: "48 points ÷ 6 equal shares",
    onceLabel: "+ one 4-point team bonus",
    choices: ["48 ÷ 6 + 4", "48 ÷ (6 + 4)", "(48 + 6) ÷ 4"],
    correct: 0,
    answer: "48 ÷ 6 + 4 = 8 + 4 = 12",
    why: "Share the 48 first. The rescue bonus is added once after each equal share is known.",
    retry: [
      "That matches the story: share first, then add the team bonus.",
